...
def bfs(start, end, V, residual_network, residual_network_values):
    stack = deque()
...
def ford_fulkerson_bfs(V, E, start, end):
    ...
    cumulative_flow = 0
    while path_and_max_possible_flow_value := bfs(start, end, V, residual_network, residual_network_values):
